$pathh = "C:\Users\" + $env:UserName + "\source\repos\SMSQueueHandler\SMSQueueHandler.sln"
$collectionOfArgs = @($pathh,"/target:Clean","/target:Build")
msbuild $collectionOfArgs

$path = "C:\Users\" + $env:UserName + "\source\repos\SMSQueueHandler\SMSQueueHandler\bin\Debug\net6.0\"
