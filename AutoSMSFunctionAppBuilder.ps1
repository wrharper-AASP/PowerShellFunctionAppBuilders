$collectionOfArgs = @("C:\Users\Administrator\source\repos\SMSQueueHandler\SMSQueueHandler.sln","/target:Clean","/target:Build")
msbuild $collectionOfArgs

$path = "C:\Users\Administrator\source\repos\SMSQueueHandler\SMSQueueHandler\bin\Debug\net6.0\"
$binpath = $path + "bin\" #lots of files
$queuetrigger = $path + "QueueTrigger\" #1 file
...
$dependfile = $path + "SMSQueueHandler.deps.json"
