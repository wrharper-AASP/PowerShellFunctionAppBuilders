$collectionOfArgs = @("C:\Users\Administrator\source\repos\WhatsappWebhookToDataverse\WhatsappWebhookToDataverse.sln","/target:Clean","/target:Build")
msbuild $collectionOfArgs

$path = "C:\Users\Administrator\source\repos\WhatsappWebhookToDataverse\bin\Debug\net6.0\"
$binpath = $path + "bin\" #lots of files
$queuetrigger = $path + "HttpTrigger1\" #1 file
...
$files = @(
    ...
    "WhatsappWebhookToDataverse.dll"
    "WhatsappWebhookToDataverse.pdb"
)
...
$dependfile = $path + "WhatsappWebhookToDataverse.deps.json"
