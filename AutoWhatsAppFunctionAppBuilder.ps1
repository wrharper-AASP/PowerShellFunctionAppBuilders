$pathh = "C:\Users\" + $env:UserName + "\source\repos\WhatsappWebhookToDataverse\WhatsappWebhookToDataverse.sln"
$collectionOfArgs = @($pathh,"/target:Clean","/target:Build")
msbuild $collectionOfArgs

$path = "C:\Users\" + $env:UserName + "\source\repos\WhatsappWebhookToDataverse\bin\Debug\net6.0\"
