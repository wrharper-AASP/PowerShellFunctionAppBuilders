$pathh = "C:\Users\" + $env:UserName + "\source\repos\\WhatsAppLockedCallback\\WhatsAppLockedCallback.sln"
$collectionOfArgs = @($pathh,"/target:Clean","/target:Build")
msbuild $collectionOfArgs

$path = "C:\Users\" + $env:UserName + "\source\repos\\WhatsAppLockedCallback\WhatsAppLockedCallback\bin\Debug\net6.0\"
...
$files = @(
    ...
    "WhatsAppLockedCallback.dll"
    "WhatsAppLockedCallback.pdb"
)
...
$dependfile = $path + "\WhatsAppLockedCallback.deps.json"
