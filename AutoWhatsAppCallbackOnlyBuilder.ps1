$pathh = "C:\Users\" + $env:UserName + "\source\repos\\WhatsAppCallbackOnly\\WhatsAppCallbackOnly.sln"
$collectionOfArgs = @($pathh,"/target:Clean","/target:Build")
msbuild $collectionOfArgs

$path = "C:\Users\" + $env:UserName + "\source\repos\\WhatsAppCallbackOnly\WhatsAppCallbackOnly\bin\Debug\net6.0\"
...
$files = @(
    ...
    "WhatsAppCallbackOnly.dll"
    "WhatsAppCallbackOnly.pdb"
)
...
$dependfile = $path + "\WhatsAppCallbackOnly.deps.json"
